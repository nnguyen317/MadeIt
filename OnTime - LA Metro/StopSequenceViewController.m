...
@interface StopSequenceViewController ()
@property (nonatomic, strong) NSMutableArray *stopSequenceList;
@end

@implementation StopSequenceViewController

@synthesize stopSequenceList = _stopSequenceList;
...
- (void)viewDidLoad
{
    ...
    _stopSequenceList = [metro getStopSequenceArrivalTimes:_stopTimes.routeId withTripId:_stopTimes.tripId withStopSequence:_stopTimes.stopSequence];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    return _stopSequenceList.count;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Metro *metro = [[Metro alloc]init];
    // Configure the cell...
    stopTimes = _stopSequenceList[indexPath.row];
    cell.stopName.text = stopTimes.stopName;
