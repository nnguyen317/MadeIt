...
- (void)viewDidLoad
{
    ...
    self.agencyList = [[NSMutableArray alloc]init];
    
    self.agencyList = [metro getMetroAgencyList:@""];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    agency = self.agencyList[indexPath.row];
    
    [[cell textLabel] setText:agency.agencyName];
...
-(void) prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender {
    if([segue.identifier isEqualToString:@"showRoutes"]) {
        ...
        Route *route = [self.agencyList objectAtIndex:indexPath.row];
        RoutesViewController *routeController = [segue destinationViewController];
